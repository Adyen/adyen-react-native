...
export interface ApplePayConfiguration {
  ...
  /** Indicates the display mode for the shipping (e.g, "Pick Up", "Ship To", "Deliver To"). Localized. The default is 'shipping'  */
  ...
  allowShippingContactEditing?: boolean;
  /** A list of ISO 3166 country codes to limit payments to cards from specific countries or regions. */
  supportedCountries?: [string];
  /** Capabilities for processing payment. The dafault */
  merchantCapabilities?: ['credit' | 'debit' | 'instantFundsOut'];
...
export interface ApplePayShippingMethod extends ApplePaySummaryItem {
  /** Additional localized information about the shipping method, e.g. "Ships in 24 hours" or "Arrives Friday April 4." */
  detail: string,
  /** Application-defined unique identifier for this shipping method. The application will receive this in paymentAuthorizationViewController:didAuthorizePayment:completion:. */
  identifier: string
}
