...
class DropInModule(
  ...
  fun action(actionMap: ReadableMap?) {
    try {
      ...
      val action = com.adyen.checkout.components.core.action.Action.SERIALIZER.deserialize(jsonObject)
  ...
  private fun buildOldCheckoutConfiguration(configuration: ReadableMap): CheckoutConfiguration {
    ...
    return CheckoutConfiguration(
      ...
      amount = rootParser.amount?.let {
        com.adyen.checkout.components.core.Amount(it.currency, it.value)
      },
    )
  }
   ...
   */
  private fun mapToOldEnvironment(
    newEnv: com.adyen.checkout.core.common.Environment,
  ): com.adyen.checkout.core.old.Environment {
